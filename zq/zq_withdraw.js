...
v2p食用说明：
1.添加重写如下：
https://kandian.youth.cn/v5/wechat/withdraw2.json 重写目标 https://raw.githubusercontent.com/shaolin-kongfu/js_scripts/main/zq/zq_withdraw.js
...
function getbody() {
    if ($request.url.match(/\/kandian.youth.cn\/v5\/wechat\/withdraw2.json/)) {
