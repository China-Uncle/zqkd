...
#看看赚
https://kandian.youth.cn/v5/nameless/adlickstart.json 重写目标 https://raw.githubusercontent.com/shaolin-kongfu/js_scripts/main/zq/zqkkz.js
[MITM]
hostname = kandian.youth.cn
*/
...
function openbox(id,zq_cookie1,timeout=0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.youth.cn/WebApi/Nameless/getBoxReward?id='+ id + '&' + zq_cookie1,
            headers : {
    'Host': 'kandian.youth.cn',
     //'Referer': 'https://kandian.youth.cn/h5/20190527watchMoney/?' +zq_cookie1
     'Referer':'https://kandian.youth.cn/h5/20190527watchMoney/?keyword_wyq=woyaoq.com&access=WIFI&app-version=8.1.2&app_version=8.1.2&carrier=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8&channel=c1005&'+zq_cookie1},
            }
...
if ($request.url.match(/\/kandian.youth.cn\/v5\/nameless\/adlickstart/)) {
...
function lookStart(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.youth.cn/v5/nameless/adlickstart.json',
...
function lookstart(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.youth.cn/v5/nameless/bannerstatus.json',
            headers : lookheader,
            body : zqlookStartbody1,}//xsgbody,}
        $.post(url, async (err, resp, data) => {
            try {
...
function reward(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.youth.cn/v5/nameless/adlickend.json',
