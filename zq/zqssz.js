...
#搜索赚
https://kandian.youth.cn/v5/Sousuo/playStart.json 重写目标 https://raw.githubusercontent.com/shaolin-kongfu/js_scripts/main/zq/zqssz.js
[MITM]
...
if ($request.url.match(/\/kandian.youth.cn\/v5\/Sousuo\/playStart.json/)) {
...
function Start(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.youth.cn/v5/Sousuo/playStart.json',
...
function look(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.youth.cn/v5/Sousuo/playStatus.json',
            headers : lookStartheader,
            body : zqsszbody1,}
        $.post(url, async (err, resp, data) => {
            try {
...
function end(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kandian.youth.cn/v5/Sousuo/playEnd.json',
            headers : lookStartheader,
            body : zqsszbody1,}
        $.post(url, async (err, resp, data) => {
            try {
